...
local IMPL      = require "path.lfs.find"
-- local IMPL      = require "path.win32.find".load("ffi").A
-- local IMPL      = require "path.win32.find".load("alien").A
-- local IMPL      = {findfile_t = require "afx".findfile}

local findfile_t = IMPL.findfile_t
